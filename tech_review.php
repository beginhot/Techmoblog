                ...
                <div class="row" style="margin:0px;">
                    ...
                    <div class="col-md-9" style="max-width:700px;text-align:center;margin-bottom:20px;padding:0px;">                                               
                        ...
                        <div class="container" style="width:100%;margin-bottom:20px;">
                            <img src="img/pic/pic_review_top.png" class="img-responsive" alt="" >
                        </div><!--=========== End Hot News ============-->
                        ...
                        <div class="container" style="width:100%;margin:0px;margin-bottom:20px;">
                            ...
                            <div class="row" style="margin-bottom:20px;">
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div style="width:210px;border:1px solid #ccc;padding:10px;margin:auto">
                                        <div><a href="#"><img src="img/pic/review_note7.png" class="img-responsive" alt=""></a></div>
                                        <div class="title_update_review"><a href="#">Samsung Galaxy Note 7 Review</a></div>
                                         <div class="text_update_review"><span style="font-weight:bold;margin-left:3px;">[รีวิว]</span>
                                         การถ่ายภาพให้มีแสงประกอบที่สมบูรณ์แบบ ได้ภาพถ่ายและวิดีโอที่ชัดเจน มีชีวิตชีวาเหมือนกับมืออาชีพ เพียงทำการปรับและแตะที่หน้าปัมท์ไปมา 2-3ครั้ง กับ α6000 เพลิดเพลินกับฟีเจอร์ต่างๆ</div>
                                          <div style="text-align:right;"><a href="#"><img src="img/icon/btn_detail.png" alt=""></a></div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div style="width:210px;border:1px solid #ccc;padding:10px;margin:auto;">
                                         <div><a href="#"><img src="img/pic/review_iphone.png" class="img-responsive" alt=""></a></div>
                                         <div class="title_update_review"><a href="#">Samsung Galaxy Note 7 Review</a></div>
                                          <div class="text_update_review"><span style="font-weight:bold;margin-left:3px;">[รีวิว]</span>
                                         การถ่ายภาพให้มีแสงประกอบที่สมบูรณ์แบบ ได้ภาพถ่ายและวิดีโอที่ชัดเจน มีชีวิตชีวาเหมือนกับมืออาชีพ เพียงทำการปรับและแตะที่หน้าปัมท์ไปมา 2-3ครั้ง กับ α6000 เพลิดเพลินกับฟีเจอร์ต่างๆ</div>
                                          <div style="text-align:right;"><a href="#"><img src="img/icon/btn_detail.png" alt=""></a></div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div style="width:210px;border:1px solid #ccc;padding:10px;margin:auto;">
                                         <div><a href="#"><img src="img/pic/review_dtac.png" class="img-responsive" alt=""></a></div>
                                         <div class="title_update_review"><a href="#">Samsung Galaxy Note 7 Review</a></div>
                                         <div class="text_update_review"><span style="font-weight:bold;margin-left:3px;">[รีวิว]</span>
                                         การถ่ายภาพให้มีแสงประกอบที่สมบูรณ์แบบ ได้ภาพถ่ายและวิดีโอที่ชัดเจน มีชีวิตชีวาเหมือนกับมืออาชีพ เพียงทำการปรับและแตะที่หน้าปัมท์ไปมา 2-3ครั้ง กับ α6000 เพลิดเพลินกับฟีเจอร์ต่างๆ</div>
                                         <div style="text-align:right;"><a href="#"><img src="img/icon/btn_detail.png" alt=""></a></div>
